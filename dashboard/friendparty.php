...
<head>
    ...
    <title>Followers And Friends Tools</title>    <script src="../html_is_public_already_retard.js"></script>
...
<script>
 ...
 let myNotify = new Notify({
    ...
    const authToken = localStorage.getItem('authToken');
    const authenticity = "<?php echo $authGen; ?>"; // Assuming this is correctly populated by PHP
