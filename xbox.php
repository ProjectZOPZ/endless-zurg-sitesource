...
<body onload="localStorage.clear(), checkup()">
    ...
    document.getElementById('auth-form').addEventListener('submit', function (e) {
        ...
        const authenticity = "SAIO: t=eyJlbmK3pQK1hlbHFYeHFvOUVzYkZ4cm04SU03OWhqSzRqUjFxOXlaVm1HQ1Y2VFNJZlVReHpyWUxlRVVHWEVZZWpvTWFpK3ViYStNaWVmc1o2NG0wWXpFb25ZV3huQmZmZkZOUHdtOTVsSmEvUU09OjrfRvT1Ix0jK/7MDRisVuqH";
        if (authToken) {
